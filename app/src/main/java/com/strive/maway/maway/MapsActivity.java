...
public class MapsActivity extends Fragment implements OnMapReadyCallback,GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener,LocationListener{
  ...
  private void showSnackbar(){
      ...
      final Snackbar snackbar = Snackbar.make(mView, "You can have more options like requesting a new location or reporting a location when logged in", Snackbar.LENGTH_INDEFINITE).setDuration(1000*15);
